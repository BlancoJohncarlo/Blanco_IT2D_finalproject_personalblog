...
<body>
<div class="container">
    <h1 class="page-header text-center">Bill and Carlo Blog</h1>
    <div class="row">
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <table class="table table-bordered table-striped" style="margin-top:20px;">
                ...
                <tbody>
                    <?php
                    //load xml file
                    $file = simplexml_load_file('filesxml/blanco_IT2D_finalproject_personalblog.xml');
                    ...
                    foreach($file->user as $row){
                        ...
                        <tr>
                            ...
                            <td><?php echo $row->zodiac; ?></td>
                            <td><?php echo $row->age; ?></td>
                            <td><?php echo $row->status; ?></td>
                            <td><?php echo $row->gender; ?></td>
                            <td><?php echo $row->crush; ?></td>
             ...
             <h5><a href ="account.php">Personal Blog</a></h5>
        </div>
    </div>
</div>
